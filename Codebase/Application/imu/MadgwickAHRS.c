...
#define sampleFreqDef 200.f // sample frequency in Hz
#define betaDef       0.0091f  // 2 * proportional gain
...
float q2 = 0.f;
float q3 = 0.f;
float invSampleFreq = 1.f / sampleFreqDef;
...
void madgwick_computeAngles(float *roll, float *pitch, float *yaw) {
    ...
    *pitch = 57.29578f * asinf(-2.f * (q1*q3 - q0*q2));
